...
// Not exactly sure what it is asking. I am going to make it so that it infinitely switches between true and false.

  changeMyMind = false ? changeMyMind = true : changeMyMind = true 
  console.log(changeMyMind)


// This works, but it makes it hard to see the rest of the answers so i will comment it out
...
// Not sure how this is different from the last question
...
//Code Here
for( let odd = 0; odd < listOfNumbers.length; odd++) {
  if (listOfNumbers[odd] % 3 === 0) {
    console.log(`${listOfNumbers[odd]} is divisible by 3`)
  }
}
